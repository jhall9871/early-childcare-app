...
Admin.create([
    {first_name: 'Jennifer', last_name: 'Higdon', pronouns: 'She/Her', salutation: 'Ms.'},
    {first_name: 'Clara', last_name: 'Schumann', pronouns: 'She/Her', salutation: 'Ms.'}
])

Teacher.create([
    {first_name: 'Magnolia', last_name: 'Smith', pronouns: 'She/Her', salutation: 'Ms.'},
    {first_name: 'Ming', last_name: 'Lee', pronouns: 'She/Her', salutation: 'Ms.'},
    {first_name: 'Jackie', last_name: 'Tennant', pronouns: 'She/Her', salutation: 'Ms.'},
    {first_name: 'Aurelia', last_name: 'Vance', pronouns: 'She/Her', salutation: 'Ms.'},
    {first_name: 'Sam', last_name: 'Willenbotham', pronouns: 'He/Him', salutation: 'Mr.'},
    {first_name: 'Blake', last_name: 'Jackson', pronouns: 'He/Him', salutation: 'Mr.'},
    {first_name: 'Antonio', last_name: 'Boyette', pronouns: 'He/Him', salutation: 'Mr.'}
])
